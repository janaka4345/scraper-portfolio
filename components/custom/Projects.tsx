    ...
    return (
        <section id='projects' className="bg-white px-4 py-8 antialiased  md:py-16">
            <div className="mx-auto grid max-w-screen-xl rounded-lg bg-gray-50 p-4  md:p-8 lg:grid-cols-12 lg:gap-8 lg:p-16 xl:gap-16">
                <div className="lg:col-span-5 lg:mt-0">
                    <Link href="/amazonscraper">
                        <img className="hover:scale-125 transition-all duration-150 mb-4 h-56 w-56 object-contain  sm:h-96 sm:w-96 md:h-full md:w-full" src="amazon.png" alt="peripherals" />
                ...
                <div className="me-auto place-self-center lg:col-span-7">
                    ...
                    <p className="mb-6 text-gray-500 ">Scraping a static website. Bypassing reCAPTCHA. Cleaning Data. Data saved in JSON file format. Can be upload to a SQL/noSQL Database   </p>
            ...
            <div className="mx-auto grid max-w-screen-xl rounded-lg bg-gray-50 p-4  md:p-8 lg:grid-cols-12 lg:gap-8 lg:p-16 xl:gap-16">
                <div className="lg:col-span-5 lg:mt-0">
                    <Link href="/walmartscraper">
                        <img className="hover:scale-125 transition-all duration-150 mb-4 h-56 w-56  sm:h-96 sm:w-96 md:h-full md:w-full" src="/walmart.png" alt="peripherals" />
                ...
                <div className="me-auto place-self-center lg:col-span-7">
                    ...
                    <p className="mb-6 text-gray-500 ">Scraping a static website directly from api endpoints. Bypassing reCAPTCHA. Cleaning Data .Data saved in JSON file format. Can be upload to a SQL/noSQL Database</p>
            ...
            <div className="mx-auto grid max-w-screen-xl rounded-lg bg-gray-50 p-4  md:p-8 lg:grid-cols-12 lg:gap-8 lg:p-16 xl:gap-16">
                <div className="lg:col-span-5 lg:mt-0">
                    <Link href="#">
                        <img className="hover:scale-125 transition-all duration-150 mb-4 h-56 w-56  sm:h-96 sm:w-96 md:h-full md:w-full" src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/imac-components.svg" alt="peripherals" />
